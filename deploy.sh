...
if [ -d "backend" ]; then
    ...
    echo "🗜️ Comprimiendo en backend.zip..."
...
if [ -d "infraestructura" ]; then
    ...
    echo "⚙️  Inicializando (terraform init)..."
    ...
    # Volvemos a la raíz al terminar
    cd ..
else
...
echo "Revisa más arriba los Outputs de Terraform para copiar:"
echo "- Tu api_url (Para conectar el Frontend)"
echo "- Tu cloudfront_domain (Para ver tu web final)"
echo "========================================================="